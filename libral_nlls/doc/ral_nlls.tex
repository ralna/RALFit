...
\itt{exact\_second\_derivatives} {\color{red} logical} that, if {\tt true}, signifies that the
...
\itt{output\_progress\_vectors} {color{red} logical} that, if true, outputs the progress vectors at the end of the routine.
