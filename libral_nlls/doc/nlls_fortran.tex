...
\newcommand{\scalarintegera}[1]{\itt{#1} is a scalar of type {\tt INTEGER} }
\newcommand{\scalarinteger}{is a scalar of type {\tt INTEGER} }
\newcommand{\scalarlogicala}[1]{\itt{#1} is a scalar of type {\tt LOGICAL} }
...
\newcommand{\scalarreala}[1]{\itt{#1} is a scalar of package type}
...
\begin{description}
   ...
   \itt{x} holds the current point $\iter{\vx}$ at which to evaluate $\vr(\vx)$.
