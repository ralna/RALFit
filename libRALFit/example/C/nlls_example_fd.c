...
int main(void) {
  // Data to be fitted
  int m = 5;
  struct params_type params = {.t = (double[]){1.0, 2.0, 4.0, 5.0, 8.0},
  ...
  double x[2] = {1.0, 0.15};               // Initial guess
  double x_exp[2] = {2.541046, 0.2595048}; // Expected solution

  double lower_bounds[2] = {0.0, 0.0};
  double upper_bounds[2] = {3.0, 10.0};
