...
void generate_data_example(double *x_data, double *y_data,
                           const int m); // prototype
int eval_F(const int n, const int m, void *params, const double *X, double *f);
int eval_J(const int n, const int m, void *params, const double *X, double *f);
int eval_HF(const int n, const int m, void *params, const double *X,
            const double *f, double *hf);
...
int eval_J(const int n, const int m, void *params, const double *X, double *J) {
...
void generate_data_example(double *x_data, double *y_data, const int m) {
  ...
  double tempy[67] = {0.907946872110432, 1.199579396036134, 1.060092431384317,
