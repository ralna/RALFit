...
project = u'RALFit (Python interface)'
...
# of the sidebar.
#
html_logo = "../common/STFC-Logo.png"
...
latex_documents = [
    (master_doc, 'RALFit.tex', u'RALFit Documentation (Python interface)',
...
man_pages = [
    (master_doc, 'ralfit', u'RALFit Documentation (Python interface)',
     [author], 1)
]
