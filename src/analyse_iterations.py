...
data9 = np.loadtxt("data/results_m9.out", dtype = info)
...
clear_best = [0, 0, 0, 0, 0, 0]
best = [0, 0, 0, 0, 0, 0]
too_many_its = [-1, -1, -1, -1, -1, -2]
...
for i in range(0,data1.shape[0]):
    print problems[i],' ',all_iterates[0,i],' ', all_iterates[1,i],' ', \
          ...
          all_iterates[4,i],' ', all_iterates[5,i]  
...
print "Hybrid (MNT) is best ",best[4]," times (and clear best ",clear_best[4]," times)"
print "GSL is best ",best[5]," times (and clear best ",clear_best[5]," times)"
