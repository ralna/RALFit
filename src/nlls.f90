!  This version: 30/09/2015 at 13:30 GMT. 
!  Copyright reserved, STFC.

     SUBROUTINE RAL_NLLS( n, X, Work_int, len_work_int,                        &
...
!   Dummy arguments
     ...
     USE ISO_FORTRAN_ENV
     INTEGER( int32 ), INTENT( IN ) :: n, len_work_int, len_work_real
...
!! ======================================================================
!! Incorporate some of the following as (optional?) arguments in RAL_NLLS
!! ======================================================================
