...
contains
  ...
  subroutine copy_control_in(ccontrol, fcontrol, f_arrays);
    ...
    fcontrol%initial_radius = ccontrol%intitial_radius
    ...
    fcontrol%radius_increase = ccontrol%eta_radius_increast
...
subroutine NLLS_default_control_d(ccontrol) bind(C)
  ...
  ccontrol%initial_radius = fcontrol%intitial_radius
  ...
  ccontrol%radius_increase = fcontrol%eta_radius_increast
